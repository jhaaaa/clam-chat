...
## Project
hollachat — encrypted messaging web app using XMTP v3 browser SDK.
...
- wagmi + viem + RainbowKit for wallet connection (Coinbase Wallet excluded due to COOP conflict)
